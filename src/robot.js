   ...
   */
   setup() {
     ...
     logger(`starting robot with id ${this.id}`);
      ...
      this.motors.j2 = new Motor({ stepper: 2, id: 'j2', board, stepPin: 4, dirPin: 5, limitPin: 28, enablePin: 35, encoderPinA: 19, encoderPinB: 18, limPos: 20, limNeg: 141, stepDeg: 55.55555556, limitDir: BACKWARDS });
